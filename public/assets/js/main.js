;(function ($) {
  ...
  $(document).ready(function () {
    ...
    const enableBlueMode = () => {
      ...
      $('.header .main-logo .logo-big img, .mobile-logo img, .logo img').attr(
        'src',
    ...
    function resize(step = 0) {
      windowHeight = $(window).height()
      $('.main-content').css('min-height', windowHeight - 70 - step)
      $('#map').css('min-height', windowHeight - 70 - step)
      if ($(window).width() < 1800) {
        $('.main-content').css('min-height', windowHeight - 60 - step)
        $('#map').css('min-height', windowHeight - 60 - step)
      }
      if ($(window).width() < 992) {
        $('.main-content').css('min-height', windowHeight - 50 - step)
        $('#map').css('min-height', windowHeight - 50 - step)
      }
    }
    ...
    const enableHorizontalMenu = () => {
      ...
      if ($('html').attr('data-menu') === 'horizontal') {
        ...
        $('.nav-close-btn').hide()
        $('body')
          .removeClass('body-padding hover-menu has-two-column-menu')
          .addClass('has-horizontal')
        $('.sidebar-dropdown-menu').hide()
        $('.sidebar-dropdown-item > .has-sub').each(function (e) {
          $('[data-dropdown="' + $(this).attr('data-dropdown') + '"]')
            .parent()
    ...
    const enableTwoColumnMenu = () => {
      ...
      if ($('html').attr('data-menu') === 'two-column') {
        $('.main-sidebar')
          .addClass('two-column-menu collapsed')
          .removeClass('horizontal-menu sidebar-hover hoverable flush-menu')
        $('.scrollable').overlayScrollbars({})
        ...
        if (!$('body').hasClass('has-two-column-menu')) {
          $('body')
            .removeClass('expanded has-horizontal hover-menu')
            .addClass('body-padding has-two-column-menu')
          $('.header').removeClass('expanded')
        }
    ...
    const enableVerticalMenu = () => {
      ...
      if ($('html').attr('data-menu') === 'vertical') {
        ...
        $('.nav-close-btn').show()
        $('body')
          .addClass('body-padding')
          .removeClass('has-horizontal expanded has-fixed-sidebar hover-menu has-two-column-menu')
        $('.header').removeClass('expanded')
    ...
    const enableFlushMenu = () => {
      ...
      if ($('html').attr('data-menu') === 'flush-mwnu') {
        $('.main-sidebar')
          .addClass('flush-menu')
          .removeClass('horizontal-menu two-column-menu sub-menu-collapsed collapsed')
        ...
        $('body')
          .addClass('body-padding')
          .removeClass('has-horizontal has-fixed-sidebar expanded has-two-column-menu')
        $('.nav-close-btn').show()
        $('.sidebar-dropdown-item > .has-sub').each(function (e) {
          $('[data-dropdown="' + $(this).attr('data-dropdown') + '"]')
            .parent()
    ...
    if (selectedStyleSheet) {
      $('.color-palette[data-color="' + selectedStyleSheet + '"]')
        .addClass('active')
        .siblings()
        .removeClass('active')
    ...
    if (navbackgroundImage) {
      $('.sidebar-bg-btn[data-img="' + navbackgroundImage + '"]')
        .addClass('active')
        .siblings()
        .removeClass('active')
    ...
    if (mainBackgroundImage) {
      $('.main-content-bg-btn[data-img="' + mainBackgroundImage + '"]')
        .addClass('active')
        .siblings()
        .removeClass('active')
    ...
    $('.has-sub').on('click', function () {
      ...
      if ($('.main-sidebar').hasClass('two-column-menu')) {
        ...
        $('#' + dropdownId)
          .show()
          .siblings('.sidebar-dropdown-menu')
          .hide()
        $('.header').removeClass('expanded')
    ...
    if ($('#allProductTable').length) {
      ...
      $('#allProductTable_filter input')
        .addClass('form-control')
        .attr('placeholder', 'Search...')
        .addClass('form-control-sm')
      $('#allProductTable_length')
        .prependTo('#productTableLength')
        .find('select')
        .addClass('form-control form-control-sm px-3')
      ...
      $('#markAllProduct').on('change', function () {
        if ($(this).is(':checked')) {
          $(this)
            ...
            .find('tbody tr .form-check-input')
            .prop('checked', true)
        } else {
          $(this)
            .parents('.dataTables_wrapper')
      ...
      $('#allProductTable').on('draw.dt', function () {
        ...
        if ($('#allProductTable_wrapper thead th input[type=checkbox]').is(':checked')) {
          $('#allProductTable_wrapper thead th input[type=checkbox]')
            .parents('.dataTables_wrapper')
            .find('tbody .form-check-input')
            .prop('checked', true)
        } else {
          $('#allProductTable_wrapper thead th input[type=checkbox]')
            .parents('.dataTables_wrapper')
    ...
    if ($('.email-table').length) {
      ...
      $('.dataTables_length').each(function () {
        $(this)
          .prependTo($(this).parents('.tab-pane').find('.productTableLength'))
          .find('select')
          .addClass('form-control form-control-sm px-3')
      })
    ...
    if ($('#componentDataTable').length) {
      ...
      $('#componentDataTable_filter input')
        .addClass('form-control')
        .attr('placeholder', 'Search...')
        .addClass('form-control-sm')
      ...
      $('#componentDataTable').on('draw.dt', function () {
        if ($('#componentDataTable_wrapper thead th input[type=checkbox]').is(':checked')) {
          $('#componentDataTable_wrapper thead th input[type=checkbox]')
            .parents('.dataTables_wrapper')
            .find('tbody .form-check-input')
            .prop('checked', true)
        } else {
    ...
    if ($('#componentDataTable2').length) {
      ...
      $('#componentDataTable2_filter input')
        .addClass('form-control')
        .attr('placeholder', 'Search...')
        .addClass('form-control-sm')
      $('.dataTables_length').find('select').addClass('form-control form-control-sm px-3')
      ...
      $('#componentDataTable2').on('draw.dt', function () {
        if ($('#componentDataTable2_wrapper thead th input[type=checkbox]').is(':checked')) {
          $('#componentDataTable2_wrapper thead th input[type=checkbox]')
            .parents('.dataTables_wrapper')
            .find('tbody .form-check-input')
            .prop('checked', true)
        } else {
    ...
    if ($('#componentDataTable3').length) {
      ...
      $('#componentDataTable3_filter input')
        .addClass('form-control')
        .attr('placeholder', 'Search...')
        .addClass('form-control-sm')
      $('.dataTables_length').find('select').addClass('form-control form-control-sm px-3')
      ...
      $('#componentDataTable3').on('draw.dt', function () {
        if ($('#componentDataTable3_wrapper thead th input[type=checkbox]').is(':checked')) {
          $('#componentDataTable3_wrapper thead th input[type=checkbox]')
            .parents('.dataTables_wrapper')
            .find('tbody .form-check-input')
            .prop('checked', true)
        } else {
    ...
    if ($('#allEmployeeTable').length) {
      ...
      $('#allEmployeeTable_filter input')
        .addClass('form-control')
        .attr('placeholder', 'Search...')
        .addClass('form-control-sm')
      $('#allEmployeeTable_length')
        .prependTo('#employeeTableLength')
        .find('select')
        .addClass('form-control form-control-sm px-3')
      ...
      $('#allEmployeeTable').on('draw.dt', function () {
        ...
        if ($('#allEmployeeTable_wrapper thead th input[type=checkbox]').is(':checked')) {
          $('#allEmployeeTable_wrapper thead th input[type=checkbox]')
            .parents('.dataTables_wrapper')
            .find('tbody .form-check-input')
            .prop('checked', true)
        } else {
    ...
    if ($('#attendanceTable').length) {
      ...
      $('#markAllAttendance').on('change', function () {
        if ($(this).is(':checked')) {
          $(this)
            .parents('.dataTables_wrapper')
            .find('tbody tr .form-check-input:not([role=switch])')
            .prop('checked', true)
        } else {
          $(this)
            .parents('.dataTables_wrapper')
      ...
      $('#attendanceTable').on('draw.dt', function () {
        ...
        if ($('#attendanceTable_wrapper thead th input[type=checkbox]').is(':checked')) {
          $('#attendanceTable_wrapper thead th input[type=checkbox]')
            .parents('.dataTables_wrapper')
            .find('tbody .form-check-input:not([role=switch])')
            .prop('checked', true)
        } else {
          $('#attendanceTable_wrapper thead th input[type=checkbox]')
            .parents('.dataTables_wrapper')
    ...
    if ($('#allCustomerTable').length) {
      ...
      $('#allCustomerTable_filter input')
        .addClass('form-control')
        .attr('placeholder', 'Search...')
        .addClass('form-control-sm')
      $('#allCustomerTable_length')
        .prependTo('#employeeTableLength')
        .find('select')
        .addClass('form-control form-control-sm px-3')
      ...
      $('#allCustomerTable').on('draw.dt', function () {
        ...
        if ($('#allCustomerTable_wrapper thead th input[type=checkbox]').is(':checked')) {
          $('#allCustomerTable_wrapper thead th input[type=checkbox]')
            .parents('.dataTables_wrapper')
            .find('tbody .form-check-input:not([role=switch])')
            .prop('checked', true)
        } else {
    ...
    if ($('#leadsTable').length) {
      ...
      $('#leadsTable').on('draw.dt', function () {
        ...
        if ($('#leadsTable_wrapper thead th input[type=checkbox]').is(':checked')) {
          $('#leadsTable_wrapper thead th input[type=checkbox]')
            .parents('.dataTables_wrapper')
            .find('tbody .form-check-input:not([role=switch])')
            .prop('checked', true)
        } else {
    ...
    if ($('#taskTable').length) {
      ...
      $('#taskTable').on('draw.dt', function () {
        ...
        if ($('#taskTable_wrapper thead th input[type=checkbox]').is(':checked')) {
          $('#taskTable_wrapper thead th input[type=checkbox]')
            .parents('.dataTables_wrapper')
            .find('tbody .form-check-input:not([role=switch])')
            .prop('checked', true)
        } else {
    ...
    if ($('#targetAudienceTable').length) {
      ...
      $('#targetAudienceTable_filter input')
        .addClass('form-control')
        .attr('placeholder', 'Search...')
        .addClass('form-control-sm')
      $('#targetAudienceTable_length')
        .prependTo('#employeeTableLength')
        .find('select')
        .addClass('form-control form-control-sm px-3')
      ...
      $('#targetAudienceTable').on('draw.dt', function () {
        ...
        if ($('#targetAudienceTable_wrapper thead th input[type=checkbox]').is(':checked')) {
          $('#targetAudienceTable_wrapper thead th input[type=checkbox]')
            .parents('.dataTables_wrapper')
            .find('tbody .form-check-input:not([role=switch])')
            .prop('checked', true)
        } else {
    ...
    if ($('#companyTable').length) {
      ...
      $('#companyTable').on('draw.dt', function () {
        ...
        if ($('#companyTable_wrapper thead th input[type=checkbox]').is(':checked')) {
          $('#companyTable_wrapper thead th input[type=checkbox]')
            .parents('.dataTables_wrapper')
            .find('tbody .form-check-input:not([role=switch])')
            .prop('checked', true)
        } else {
    ...
    if ($('.multi-step-signup-panel').length) {
      $('.next-button').on('click', function () {
        ...
        $('.step-list li:nth-child(' + processing_step_number + ')')
          .addClass('active')
          .siblings()
          .removeClass('active')
      })
